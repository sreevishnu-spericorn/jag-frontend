...
import { BrandIcons, LogoIcon, MiscIcons, NavIcons, WidgetIcons } from "@/components/dashboard/DashboardIcons";
...
const Dashboard = () => {
   // Dummy Data
   const salesData = [
      350, 400, 380, 450, 520, 420, 480, 400, 550, 520, 300, 450,
   ];
   const commissionData = [
      250, 300, 320, 280, 350, 400, 420, 410, 450, 430, 380, 400,
   ];
   const months = [
      "JAN",
      "FEB",
         ...
         <div className="flex-1 h-screen overflow-hidden flex relative shadow-[-20px_0_40px_rgba(0,0,0,0.2)]">
            <div className="flex-1 h-full overflow-y-auto p-8 pb-20 scrollbar-thin scrollbar-thumb-slate-300 scrollbar-track-transparent">
               ...
               <div className="space-y-6">
                  <ChartContainer title="Sales vs Date">
                     <CustomChart
                        type="bar"
                        data={salesData}
                        labels={months}
                  ...
                  <ChartContainer title="Commission vs Date">
                     <CustomChart
                        type="line"
                        data={commissionData}
                        labels={months}
            ...
            <div className="w-[360px] shrink-0 bg-[#F1F5F9] h-full overflow-y-auto border-l border-slate-200/50 p-6 scrollbar-thin">
